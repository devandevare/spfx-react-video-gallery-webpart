export default class CONSTANTS {
    ...
    public static SELECTCOLUMNS = {
        ...
        VIDEO_GALLERY: "VideoURL,VideoThumbnail",
    ...
    public static LIST_VALIDATION_COLUMNS = {
        ...
        VIDEO: ["Video URL", "Video Thumbnail"],
    ...
    public static SYS_CONFIG = {
        ...
        VIDEO_GALLERY_LIST_NOT_MATCH: "Please select appropriate list with Video URL, Video Thumbnail fields",
        ...
        SELECT_LIST: "Please edit the webpart to select a Video List",
